...
class Parking(object):
    """
    Parking details about parking slots
    """
    ...
    def Park(self, reg, driver_age, age):
        ...
        if available_slot:
            ...
            available_slot.car = car.Car.create(reg, age)
            available_slot.available = False
            print("Car with vehicle registration number ",reg," has been parked at slot number ",available_slot.slot_no)
        else:
    ...
    def Leave(self, slot_no):
        ...
        if slot_no in self.slots:
            ...
            if not pslot.available and pslot.car:
                ...
                # the car with vehicle registration number",car.reg,
    ...
    def Status(self):
        ...
        for i in list(self.slots.values()):
            if not i.available and i.car:
                print("%s\t%s\t%s" % (i.slot_no, i.car.reg, i.car.age))
    ...
    def Slot_number_for_car_with_number(self, reg):
